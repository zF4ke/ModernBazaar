...
4. Set the return URLs to the real domain:
   ```
   STRIPE_SUCCESS_URL=https://www.modernbazaar.dev/dashboard/profile?checkout=success
   STRIPE_CANCEL_URL=https://www.modernbazaar.dev/dashboard/profile?checkout=cancelled
   STRIPE_PORTAL_RETURN_URL=https://www.modernbazaar.dev/dashboard/profile
   ```
...
| `CORS_ALLOWED_ORIGINS` | `https://www.modernbazaar.dev,https://modernbazaar.dev` |
